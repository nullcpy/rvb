...
| [rvx-morphed](https://github.com/wchill/rvx-morphed)                           | Reddit          | universal | `^reddit-rvx-morphed-v[\d.]+-all\.apk$`                                     | ✅    |
...
- [MicroG](https://github.com/WSTxda/MicroG-RE) is required for Google APKs to work properly.
