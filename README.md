...
- [MicroG-RE](https://github.com/MorpheApp/MicroG-RE/releases) is required for Google APKs to work properly. If you can't login with MicroG-RE then use old [MicroG](https://github.com/ReVanced/GmsCore/releases).
